# <p align="center">React Redux (Part 1)</p>

# Description

This project focuses on implementing Redux Toolkit for state management in a React application. You'll learn to create Redux slices, manage application state with a centralized store, handle asynchronous operations with thunks, and integrate Redux with React components using hooks.
...
### Task 0. Update Project Structure
